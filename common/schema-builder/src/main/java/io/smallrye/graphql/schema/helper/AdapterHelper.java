...
public class AdapterHelper {
    ...
    public static boolean shouldCreateTypeInSchema(Annotations annotations) {
        return !hasAnyAdapters(annotations);
    }
     ...
     */
    public static Optional<Adapter> getAdapter(Field field, Annotations annotations) {
        return getAdapter(field.getReference(), annotations);
    }

    /**
     * Get the adapter for a certain reference.
     * 
     * @param r
     * @param annotations the annotations
    ...
    public static Optional<Adapter> getAdapter(Reference r, Annotations annotations) {

        Type type = getAdapterType(annotations);
        if (type != null) {
    ...
    private static boolean hasAnyAdapters(Annotations annotations) {
        Type type = getAdapterType(annotations);
        return type != null;
    }
    ...
    private static Type getAdapterType(Annotations annotations) {
        // @JsonbTypeAdapter(MyBitSetAdaptor.class)
        if (annotations != null && annotations.containsOneOfTheseAnnotations(Annotations.JSONB_TYPE_ADAPTER)) {
