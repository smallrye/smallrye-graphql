...
public class Scalars {
    ...
    static {
        ...
        populateScalar("tools.jackson.databind.node.ObjectNode", STRING, String.class.getName());
        populateScalar("tools.jackson.databind.node.ArrayNode", STRING, String.class.getName());
