 ...
 */
public class DateTimeScalar extends GraphQLScalarType implements Transformable {
    ...
    public DateTimeScalar() {
        super("DateTime", "Scalar for " + LocalDateTime.class.getName(), new Coercing() {
            ...
            public Object serialize(Object input) throws CoercingSerializeException {
                ...
                try {
                    ...
                    throw new CoercingSerializeException(
                            "Expected type 'DateTime' but was '" + input.getClass().getSimpleName() + "'.", e);
                }
            }
            ...
            public Object parseValue(Object input) throws CoercingParseValueException {
                ...
                try {
                    ...
                    throw new CoercingParseValueException(
                            "Expected type 'DateTime' but was '" + input.getClass().getSimpleName() + "'.");
                }
            }
    ...
    public Object transform(String name, String input, Type type, Annotations annotations) {
        try {
            ...
            } else if (type.name().equals(Classes.UTIL_DATE)) {
                return toUtilDate(localDateTime);
            } else if (type.name().equals(Classes.SQL_TIMESTAMP)) {
                return toSqlDate(localDateTime);
            } else {
                LOG.warn("Can not transform type [" + type.name() + "] with DateTimeScalar");
                return input;
            }
    ...
    static {
        ...
        SUPPORTED_TYPES.add(Timestamp.class);
    }
}
