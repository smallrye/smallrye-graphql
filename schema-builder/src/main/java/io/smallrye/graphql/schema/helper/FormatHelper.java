...
public class FormatHelper {
    ...
    //    public static NumberFormat getNumberFormat(Annotations annotations) {
    ...
    //    public static DateTimeFormatter getDateFormat(Type type, Annotations annotations) {
    ...
    //    public static DateTimeFormatter getDateFormat(Type type, AnnotationInstance jsonbDateFormatAnnotation) {
    ...
    //    public static DateTimeFormatter getDefaultDateTimeFormatter(Type type) {
    ...
    //    private static NumberFormat getNumberFormat(AnnotationInstance jsonbNumberFormatAnnotation) {
