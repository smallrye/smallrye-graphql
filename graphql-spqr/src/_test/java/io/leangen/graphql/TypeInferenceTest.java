...
public class TypeInferenceTest {
    ...
    public void testExplicitRootTypes() {
        AnnotatedType t1 = new TypeToken<Comparable<Long>>() {
        }.getAnnotatedType();
        AnnotatedType t2 = new TypeToken<Comparable<Double>>() {
        }.getAnnotatedType();
        Type expected = new TypeToken<Comparable<Number>>() {
        }.getType();
    ...
    public void testIncompleteListTypes() {
        AnnotatedType t1 = new TypeToken<ArrayList<ArrayList<ArrayList<String>[]>>[]>() {
        }.getAnnotatedType();
        AnnotatedType t2 = new TypeToken<LinkedList<LinkedList<LinkedList[]>>[]>() {
        }.getAnnotatedType();
        ClassUtils.getCommonSuperType(Arrays.asList(t1, t2));
    }
    ...
    public void testMixedRawTypes() {
        AnnotatedType t1 = new TypeToken<ArrayList<String>>() {
        }.getAnnotatedType();
        AnnotatedType t2 = GenericTypeReflector.annotate(LinkedList.class);
        ClassUtils.getCommonSuperType(Arrays.asList(t1, t2));
    }
    ...
    public void testUnboundedWildcardTypes() {
        AnnotatedType t1 = new TypeToken<ArrayList<?>>() {
        }.getAnnotatedType();
        AnnotatedType t2 = new TypeToken<LinkedList<?>>() {
        }.getAnnotatedType();
        AnnotatedType expected = new TypeToken<AbstractList<?>>() {
        }.getAnnotatedType();
    ...
    public void testMixedWildcardTypes() {
        AnnotatedType t1 = new TypeToken<ArrayList<? extends Long>>() {
        }.getAnnotatedType();
        AnnotatedType t2 = new TypeToken<LinkedList<Double>>() {
        }.getAnnotatedType();
        AnnotatedType expected = new TypeToken<AbstractList<Number>>() {
        }.getAnnotatedType();
        assertTrue(GenericTypeReflector.equals(expected, ClassUtils.getCommonSuperType(Arrays.asList(t1, t2))));
    }
    ...
    public <T> void testUnboundedTypeVariables() {
        AnnotatedType t1 = new TypeToken<ArrayList<T>>() {
        }.getAnnotatedType();
        AnnotatedType t2 = new TypeToken<LinkedList<T>>() {
        }.getAnnotatedType();
        AnnotatedType expected = new TypeToken<AbstractList<T>>() {
        }.getAnnotatedType();
        assertTrue(GenericTypeReflector.equals(expected, ClassUtils.getCommonSuperType(Arrays.asList(t1, t2))));
    }
    ...
    public <T, S> void testIncompatibleUnboundedTypeVariables() {
        ...
        AnnotatedType t2 = new TypeToken<LinkedList<S>>() {
        }.getAnnotatedType();
        AnnotatedType expected = new TypeToken<AbstractList<T>>() {
        }.getAnnotatedType();
        assertTrue(GenericTypeReflector.equals(expected, ClassUtils.getCommonSuperType(Arrays.asList(t1, t2))));
