...
public class TypeTransformerTest {
    ...
    public void testRawReplacement() {
        Type expected = new TypeToken<List<Map<Object, Object>>>() {
        }.getType();
        AnnotatedType subject = new TypeToken<List<Map>>() {
        }.getAnnotatedType();
    ...
    public void testUnboundedReplacement() {
        Type expected = new TypeToken<List<Map<String, Object>>>() {
        }.getType();
        AnnotatedType subject = new TypeToken<List<Map<String, ?>>>() {
        }.getAnnotatedType();
        assertEquals(expected, replacing.transform(subject).getType());
    }
    ...
    public void testLowerBoundErasure() {
        Type expected = new TypeToken<List<Map<String, Number>>>() {
        }.getType();
        AnnotatedType subject = new TypeToken<List<Map<String, ? extends Number>>>() {
        }.getAnnotatedType();
        assertEquals(expected, replacing.transform(subject).getType());
    }
    ...
    public void testUpperBoundErasure() {
        ...
        AnnotatedType subject = new TypeToken<List<Map<String, ? super Number>>>() {
        }.getAnnotatedType();
        assertEquals(expected, replacing.transform(subject).getType());
    }
    ...
    public void testCustomRawReplacement() {
        Type expected = new TypeToken<List<Map<Long, Long>>>() {
        }.getType();
        AnnotatedType subject = new TypeToken<List<Map>>() {
        }.getAnnotatedType();
    ...
    public void testCustomUnboundedReplacement() {
        Type expected = new TypeToken<List<Map<String, Double>>>() {
        }.getType();
        AnnotatedType subject = new TypeToken<List<Map<String, ?>>>() {
        }.getAnnotatedType();
