...
public class TypeInfoTest {
    ...
    private void testImplicitTypeInfo(boolean respectJavaDeprecation) {
        GraphQLSchema schema = new GraphQLSchemaGenerator()
                .withOperationsFromSingleton(new BoringService(),
                        new PublicResolverBuilder().withJavaDeprecationRespected(respectJavaDeprecation))
                .generate();
    ...
    public enum BunnyType {
        @EnumValue(value = "IntenselyCute")
        CUTE,
        @EnumValue(description = "Thoroughly adorable")
        ADORABLE,
        @io.leangen.graphql.annotations.Deprecated("Impossible")
        MEH,
        @Deprecated
        AVERAGE,
        @Deprecated
