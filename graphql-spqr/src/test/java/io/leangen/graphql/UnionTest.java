...
public class UnionTest {
    ...
    private class InlineUnionService {
        @Query(value = "union")
        public List<Map<@io.leangen.graphql.annotations.GraphQLUnion(name = "Simple_One_Two") ? super SimpleOne, @io.leangen.graphql.annotations.GraphQLUnion(name = "Education_Street") Street>> union(
                @Argument(value = "id") int id) {
            return null;
        }

        @Query(value = "union")
        public @GraphQLNonNull List<Map<@io.leangen.graphql.annotations.GraphQLUnion(name = "Simple_One_Two") ? extends SimpleTwo, @io.leangen.graphql.annotations.GraphQLUnion(name = "Education_Street") Education>> union2(
                @Argument(value = "id") int id) {
            return null;
        }

        @Query(value = "union")
        public List<Map<@io.leangen.graphql.annotations.GraphQLUnion(name = "Simple_One_Two", description = "nice") SimpleTwo, @io.leangen.graphql.annotations.GraphQLUnion(name = "Education_Street") Street>> union3(
                @Argument(value = "id") int id) {
            return null;
        }
    }
