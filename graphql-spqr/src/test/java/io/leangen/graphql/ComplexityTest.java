...
public class ComplexityTest {
    ...
    public void fragmentComplexityTest() {
        testComplexity(new UserService<Education>(), new TypeToken<UserService<Education>>() {
        }.getAnnotatedType(), fragmentQuery, 11, 32);
    }
    ...
    private void testComplexity(Object service, String operation, int maxComplexity, int expectedComplexity) {
        testComplexity(service, GenericTypeReflector.annotate(service.getClass()), operation, maxComplexity,
                expectedComplexity);
    }

    private void testComplexity(Object service, AnnotatedType serviceType, String operation, int maxComplexity,
