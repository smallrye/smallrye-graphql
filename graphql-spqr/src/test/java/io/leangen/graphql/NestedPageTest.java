...
public class NestedPageTest {
    ...
    public static class VoteService {
        ...
        public Page<Vote> getUserVotes(@Source User user, @Argument(value = "first") int first,
                @Argument(value = "after") String after) {
            List<Vote> votes = Arrays.asList(new Vote("x1", "http://bojack.example.com"),
                    new Vote("x2", "http://diane.example.com"));
