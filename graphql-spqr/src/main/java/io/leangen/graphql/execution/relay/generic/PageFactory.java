...
public class PageFactory {
    ...
    public static <N, P extends Page<N>> P createOffsetBasedPage(List<N> nodes, long count, long offset,
    ...
    public static <N, E extends Edge<N>, C extends Connection<E>> C createOffsetBasedConnection(
            List<N> nodes, long count, long offset, BiFunction<N, ConnectionCursor, E> edgeCreator,
        ...
        return connectionCreator.apply(edges,
                createPageInfo(edges, hasNextPage(nodes.size(), count, offset), hasPreviousPage(count, offset)));
    }

    public static <N> Page<N> createPage(List<N> nodes, CursorProvider<N> cursorProvider, boolean hasNextPage,
    ...
    public static <N, E extends Edge<N>> List<E> createEdges(List<N> nodes, CursorProvider<N> cursorProvider,
