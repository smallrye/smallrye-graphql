...
public class GsonValueMapper implements ValueMapper, InputFieldBuilder {
     ...
     * reimplementation of
     * {@link com.google.gson.internal.bind.ReflectiveTypeAdapterFactory#getBoundFields(Gson, com.google.gson.reflect.TypeToken, Class)}
     *
    ...
    public Set<InputField> getInputFields(InputFieldBuilderParams params) {
        ...
        while (raw != Object.class) {
            ...
            for (Field field : fields) {
                ...
                if (!params.getEnvironment().inclusionStrategy.includeInputField(target.getDeclaringClass(),
                        (AnnotatedElement) target, fieldType)) {
                    continue;
                }
    ...
    protected Object defaultValue(Field field, AnnotatedType fieldType, GlobalEnvironment environment) {
        return inputInfoGen.defaultValue(ClassUtils.getPropertyMembers(field), fieldType,
                (element, type, val) -> fromString((String) val, type), environment).orElse(null);
    }
