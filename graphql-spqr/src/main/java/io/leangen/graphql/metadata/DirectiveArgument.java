...
public class DirectiveArgument {
    ...
    public DirectiveArgument(String name, String description, AnnotatedType javaType, Object value, Object defaultValue,
            AnnotatedElement element, Annotation annotation) {
        this.name = name;
