...
public class DirectiveValueDeserializer implements ArgumentInjector {
    ...
    private static final Introspection.DirectiveLocation[] SORTED_LOCATIONS = { FIELD, INLINE_FRAGMENT, FRAGMENT_SPREAD,
            FRAGMENT_DEFINITION, QUERY, MUTATION };
    ...
    public Object getArgumentValue(ArgumentInjectorParams params) {
        ...
        String fallBackDirectiveName = env.globalEnvironment.typeInfoGenerator.generateDirectiveTypeName(params.getBaseType(),
                env.globalEnvironment.messageBundle);
        ...
        Stream<Introspection.DirectiveLocation> locations = descriptor.locations().length != 0
                ...
                : sortedLocations(params.getResolutionEnvironment().dataFetchingEnvironment.getGraphQLSchema()
                        .getDirective(directiveName).validLocations());
        ...
        Object deserializableValue = allDirectives ? rawValues.collect(Collectors.toList())
                : rawValues.findFirst().orElse(null);
