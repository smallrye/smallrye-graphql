...
public class EnumMapToObjectTypeAdapter<E extends Enum<E>, V> extends CachingMapper<GraphQLObjectType, GraphQLInputObjectType>
        implements InputConverter<EnumMap<E, V>, Map<String, V>> {
    ...
    @Override
    protected GraphQLObjectType toGraphQLType(String typeName, AnnotatedType javaType, OperationMapper operationMapper,
    ...
    @Override
    protected GraphQLInputObjectType toGraphQLInputType(String typeName, AnnotatedType javaType,
    ...
    @Override
    public EnumMap<E, V> convertInput(Map<String, V> substitute, AnnotatedType type, GlobalEnvironment environment,
        ...
        Map<E, V> m = substitute.entrySet().stream()
                .collect(Collectors.toMap(e -> values.get(e.getKey()), Map.Entry::getValue));
    ...
    public AnnotatedType getSubstituteType(AnnotatedType original) {
        ...
        return TypeFactory.parameterizedAnnotatedClass(Map.class, original.getAnnotations(),
                GenericTypeReflector.annotate(String.class, keyType.getAnnotations()), valueType);
    }
