...
public class OperationSourceRegistry {
    ...
    public void registerOperationSource(Object querySourceBean, AnnotatedType beanType,
        ...
        this.operationSources.add(
                new OperationSource(querySourceBean, beanType, extractors.isEmpty() ? topLevelResolverBuilders : extractors));
    }
    ...
    public void registerNestedOperationSource(AnnotatedType domainType, Collection<ResolverBuilder> extractors) {
        this.nestedOperationSources.put(domainType,
                new OperationSource(domainType, extractors.isEmpty() ? nestedResolverBuilders : extractors));
    }
    ...
    public OperationSource nestedSourceForType(AnnotatedType domainType) {
        return nestedOperationSources.computeIfAbsent(domainType,
                javaType -> new OperationSource(javaType, nestedResolverBuilders));
    }
