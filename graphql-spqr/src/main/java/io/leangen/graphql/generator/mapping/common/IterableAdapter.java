...
public class IterableAdapter<T> extends AbstractTypeSubstitutingMapper<List<T>>
        implements InputConverter<Iterable<T>, List<T>> {
    ...
    @Override
    public Iterable<T> convertInput(List<T> substitute, AnnotatedType type, GlobalEnvironment environment,
    ...
    public boolean supports(AnnotatedType type) {
         ...
         * GenericTypeReflector.isSuperType(Iterable.class, type.getType()) &&
         * !GenericTypeReflector.isSuperType(Collection.class, type.getType());
