...
public abstract class UnionMapper implements TypeMapper {
    ...
    protected GraphQLOutputType toGraphQLUnion(String name, String description, AnnotatedType javaType,
        ...
        buildContext.directiveBuilder.buildUnionTypeDirectives(javaType, buildContext.directiveBuilderParams())
                .forEach(directive -> builder.withDirective(operationMapper.toGraphQLDirective(directive, buildContext)));
