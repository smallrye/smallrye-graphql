...
public class MapToListTypeAdapter<K, V> extends AbstractTypeAdapter<Map<K, V>, List<MapToListTypeAdapter.MapEntry<K, V>>> {
    ...
    @Override
    public List<MapToListTypeAdapter.MapEntry<K, V>> convertOutput(Map<K, V> original, AnnotatedType type,
    ...
    @Override
    public Map<K, V> convertInput(List<MapEntry<K, V>> original, AnnotatedType type, GlobalEnvironment environment,
            ValueMapper valueMapper) {
        Map<K, V> initial = GenericTypeReflector.isSuperType(type.getType(), HashMap.class) ? new HashMap<>()
                : ClassUtils.instance(type);
    ...
    public AnnotatedType getSubstituteType(AnnotatedType original) {
        ...
        Type entryType = TypeFactory.parameterizedClass(MapToListTypeAdapter.MapEntry.class, keyType.getType(),
                valueType.getType());
