...
public class SchemaTransformerRegistry {
    ...
    public GraphQLFieldDefinition transform(GraphQLFieldDefinition field, Operation operation, OperationMapper operationMapper,
    ...
    public GraphQLInputObjectField transform(GraphQLInputObjectField field, InputField inputField,
    ...
    public GraphQLArgument transform(GraphQLArgument argument, OperationArgument operationArgument,
            OperationMapper operationMapper, BuildContext buildContext) {
        for (SchemaTransformer transformer : transformers) {
    ...
    public GraphQLArgument transform(GraphQLArgument argument, DirectiveArgument directiveArgument,
            OperationMapper operationMapper, BuildContext buildContext) {
        for (SchemaTransformer transformer : transformers) {
    ...
    public GraphQLDirective transform(GraphQLDirective directive, Directive directiveModel, OperationMapper operationMapper,
            BuildContext buildContext) {
        for (SchemaTransformer transformer : transformers) {
