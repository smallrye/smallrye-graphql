...
public class ObjectScalarMapper extends CachingMapper<GraphQLScalarType, GraphQLScalarType>
    ...
    @Override
    public GraphQLScalarType toGraphQLType(String typeName, AnnotatedType javaType, OperationMapper operationMapper,
            BuildContext buildContext) {
        GraphQLDirective[] directives = buildContext.directiveBuilder
    ...
    @Override
    public GraphQLScalarType toGraphQLInputType(String typeName, AnnotatedType javaType, OperationMapper operationMapper,
            BuildContext buildContext) {
    ...
    public int compare(AnnotatedType o1, AnnotatedType o2) {
        ...
        return ClassUtils.removeAnnotations(o1, scalarAnnotation).equals(ClassUtils.removeAnnotations(o2, scalarAnnotation)) ? 0
                : -1;
    }
}
