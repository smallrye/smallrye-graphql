...
public class JsonNodeAdapter implements TypeMapper, InputConverter<JsonNode, Object>, OutputConverter<JsonNode, Object> {
    ...
    public JsonNode convertInput(Object substitute, AnnotatedType type, GlobalEnvironment environment,
    ...
    public AnnotatedType getSubstituteType(AnnotatedType original) {
        return GenericTypeReflector.annotate(mappings.get(ClassUtils.getRawType(original.getType())).substituteClass,
    ...
    static {
        ...
        typeMapping.put(TextNode.class,
                new JsonNodeDescriptor<>(String.class, JsonNodeFactory.instance::textNode, TextNode::textValue));
        typeMapping.put(BooleanNode.class,
                new JsonNodeDescriptor<>(Boolean.class, JsonNodeFactory.instance::booleanNode, BooleanNode::booleanValue));
        typeMapping.put(BinaryNode.class, new JsonNodeDescriptor<>(byte[].class, BinaryNode::new, BinaryNode::binaryValue));
        typeMapping.put(DecimalNode.class,
                new JsonNodeDescriptor<>(BigDecimal.class, DecimalNode::new, DecimalNode::decimalValue));
        typeMapping.put(BigIntegerNode.class,
                new JsonNodeDescriptor<>(BigInteger.class, BigIntegerNode::new, BigIntegerNode::bigIntegerValue));
        ...
        typeMapping.put(NumericNode.class,
                new JsonNodeDescriptor<>(BigDecimal.class, DecimalNode::new, DecimalNode::decimalValue));
