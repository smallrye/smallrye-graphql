...
public class JacksonScalars {
    ...
    public static final GraphQLScalarType JsonBinaryNode = new GraphQLScalarType("JsonBase64Binary",
            "Base64-encoded binary JSON node", new Coercing() {
    ...
    public static final GraphQLScalarType JsonBooleanNode = new GraphQLScalarType("JsonBoolean", "Boolean JSON node",
            new Coercing() {
    ...
    public static final GraphQLScalarType JsonDecimalNode = new GraphQLScalarType("JsonNumber", "Decimal JSON node",
            new Coercing() {
    ...
    public static final GraphQLScalarType JsonIntegerNode = new GraphQLScalarType("JsonInteger", "Integer JSON node",
            new Coercing() {
                    ...
                    if (input instanceof Number || input instanceof String) {
                        try {
                            ...
                            throw new CoercingParseValueException(
                                    input + " does not fit into an int without a loss of precision");
                        }
                    }
    ...
    public static final GraphQLScalarType JsonBigIntegerNode = new GraphQLScalarType("JsonBigInteger", "BigInteger JSON node",
            new Coercing() {
    ...
    public static final GraphQLScalarType JsonDoubleNode = new GraphQLScalarType("JsonDouble", "Double JSON node",
            new Coercing() {
