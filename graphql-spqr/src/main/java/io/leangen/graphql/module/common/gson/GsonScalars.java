...
public class GsonScalars {
    ...
    public static final GraphQLScalarType JsonPrimitiveNode = new GraphQLScalarType("JSONPrimitive", "A primitive JSON value",
            new Coercing() {
    ...
    private static JsonElement parseJsonValue(Value value) {
        ...
        if (value instanceof ObjectValue) {
            ...
            ((ObjectValue) value).getObjectFields()
                    .forEach(objectField -> result.add(objectField.getName(), parseJsonValue(objectField.getValue())));
            return result;
        }
