...
public class Directives {
    ...
    public static boolean isMappedType(GraphQLType type) {
        return type instanceof GraphQLDirectiveContainer && DirectivesUtil
                .directiveWithArg(((GraphQLDirectiveContainer) type).getDirectives(), MAPPED_TYPE, TYPE).isPresent();
    }
    ...
    public static AnnotatedType getMappedType(GraphQLType type) {
        return DirectivesUtil.directiveWithArg(((GraphQLDirectiveContainer) type).getDirectives(), MAPPED_TYPE, TYPE)
                ...
                .orElseThrow(() -> new IllegalArgumentException(
                        "GraphQL type " + type.getName() + " does not have a mapped Java type"));
    }
    ...
    private static final GraphQLScalarType UNREPRESENTABLE = new GraphQLScalarType("UNREPRESENTABLE", "Unrepresentable type",
            new Coercing() {
