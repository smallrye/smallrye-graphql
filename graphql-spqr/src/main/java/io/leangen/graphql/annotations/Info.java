 ...
 * <li>{@link io.leangen.graphql.metadata.strategy.value.ValueMapper} - Injects a
 * {@link io.leangen.graphql.metadata.strategy.value.ValueMapper} appropriate for the current resolver</li>
 * <li>{@link io.leangen.graphql.execution.ResolutionEnvironment} - Injects the entire
 * {@link io.leangen.graphql.execution.ResolutionEnvironment}</li>
 * </ol>
 */
@Ignore
